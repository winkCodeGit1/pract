...
import NewConsultationMaster from 'pages/Consultation/NewConsultation';
import { AdapterDateFns } from '@mui/x-date-pickers/AdapterDateFns';
import In from 'date-fns/locale/en-IN';
import { LocalizationProvider } from '@mui/x-date-pickers/LocalizationProvider';
import LabName from 'pages/master/lab/labs';
import * as api from 'pages/api/lab';
...
test('render DetailPanel correctly', () => {
  render(<DetailPanel />);
});
...
describe('LabName Component', () => {
  beforeEach(() => jest.clearAllMocks());

  it('should render lab names when API responds', async () => {
    ...
    api.labAll.mockImplementation(async (options) => {
    ...
    await waitFor(() => {
      expect(api.labAll).toHaveBeenCalledWith(
