...
const defaultValues = {
    ExternalReportLab: [defaultarry]
};
const schema = yup.object().shape({
    ExternalReportLab: yup.array().of(
        yup.object().shape({
...
function LaboratoryInvestigate() {
                            ...
                            <MuiTable size='small'>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>Normal Test Ranges</TableCell>
                                    ...
                                    {fields?.map((item, index) => (
                                        <TableRow key={item.id}>
                                            <TableCell align='center'>
                                                <RHFDatePicker
                                                    name={`ExternalReportLab[${index}.InvestigationDate]`}
                                                    format='dd-MM-yyyy'
                                                    disableFuture
                                                />
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <RHFAutoComplete
                                                    name={`ExternalReportLab[${index}.TestName]`}
                                            ...
                                            <TableCell>
                                                <RHFAutoComplete
                                                    name={`ExternalReportLab[${index}.TestMethod]`}
                                                    placeholder='Select Category'
                                                />
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <RHFCheckbox
                                                    name={`ExternalReportLab[${index}.AbnormalCheck]`}
                                                />
                                            </TableCell>
                                            <TableCell>
                                                <RHFTextField
                                                    name={`ExternalReportLab[${index}.FindingCheck]`}
                                                />
                                            </TableCell>
                                            <TableCell>
                                                <RHFTextField
                                                    name={`ExternalReportLab[${index}.NormalTestRanges]`}
                                                />
                                            </TableCell>
                                            <TableCell>
                                                <RHFTextField
                                                    name={`ExternalReportLab[${index}.Units]`}
                                                />
                                            </TableCell>
                                            <TableCell>
                                                <RHFTextField
                                                    name={`ExternalReportLab[${index}.Comments]`}
                                                />
                                            </TableCell>
...
export default LaboratoryInvestigate;
